...
export default class FacebookPost extends Component<FacebookPostProps> {
    render() {
        ...
        return (
            <iframe src={ src } width="552" height="384" style={ ({ border: 'none', overflow: 'hidden' }) } scrolling="no" frameBorder="0" allowFullScreen={true} allow="autoplay; clipboard - write; encrypted - media; picture -in -picture; web - share"></iframe>
        );
    }
}